...
url = "https://api.coingecko.com/api/v3/coins/bitcoin/market_chart?vs_currency=USD&days=1&interval=5-minutely"
...
plt.tight_layout()
axs[0].get_figure().savefig("bitcoin_marketsummary_5minute_day.png")
