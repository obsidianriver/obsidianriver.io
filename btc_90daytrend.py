...
plt.tight_layout()
axs[0].get_figure().savefig("bitcoin_market_cap_hourly_90day.png")
axs[1].get_figure().savefig("bitcoin_volume.png_hourly_90day")
axs[2].get_figure().savefig("bitcoin_price.png_hourly_90day")
