...
url = "https://api.coingecko.com/api/v3/coins/bitcoin/market_chart?vs_currency=USD&days=3650&interval=daily"
...
ax.set_title("Bitcoin Price and Moving Averages 10 Year Trend")
ax.set_xlabel("Date")
...
# Change y-axis to a log scale
ax.set_yscale('log')

# Save the plot as a file
plt.tight_layout()
fig.savefig("bitcoin_movingavg_log.png")
